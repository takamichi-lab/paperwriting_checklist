...
## ファイル形式
- <input disabled="" type="checkbox"> 図中に文字が含まれる場合，ベクタ形式 (pdf など) を使用していますか（テキストを選択できる状態ですか）？ 文字が含まれない場合は，jpg, png でも良いです．
...
- <input disabled="" type="checkbox"> label は caption の後に置いていますか？
...
- <input disabled="" type="checkbox"> 縦軸と横軸のラベルを書きましたか？フォントサイズを大きくして文字同士が重複する場合は，縦にすると良いです．
...
- <input disabled="" type="checkbox"> 本文での引用位置と，図表の位置は出来るだけ近い位置にありますか？遠い位置にあると，読者がページを行ったり来たりしなければなりません．

## その他
- <input disabled="" type="checkbox"> 図のネストは 1 段階までになっていますか？例えば，Fig. 1，Fig. 1 (a) は OK ですが，Fig. 1 (a)(1) は NG です．
- <input disabled="" type="checkbox"> figure 環境で描いていますか？ただし，2カラム原稿でどうしても1カラムに収まらない時だけ figure* 環境で描いて良いです．
